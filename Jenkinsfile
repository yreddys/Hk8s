...
pipeline {
    ...
    parameters {
        ...
        string(name: 'docker_repo', description: "Name of docker repository",defaultValue: "yreddys211")
    }
    ...
    stages {
        ...
        stage("Run Application") {
            ...
            steps {
                sh "kubectl apply -f ${WORKSPACE}/kubernetes-configmap-reload/kubernetes-configmap.yml"
            }
        }
    }
}
